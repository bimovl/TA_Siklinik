...
@section('title', 'Edit periksa ' . $periksa['id_periksa'])
@section('content')
        ...
        <div class="card-body table-responsive">
            <div class="row">
                <div class="col-md-4 offset-md-4">
                    <form action="{{url ('/periksa/update')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">                      
                        <label> Status </label>
                        <select name="status" id="status" value="{{$periksa['status']}}" class="form-control">
