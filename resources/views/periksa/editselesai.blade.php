            ...
            <div class="card-body table-responsive">
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <form action="{{url ('/periksa/updateselesai')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div>
                            <label> Status </label>
                            <select name="status"  value="{{$periksa['status']}}" class="form-control">
                        ...
                        <a href="{{ url('periksa/selesai') }}" class="btn btn-danger">Batal </a>
