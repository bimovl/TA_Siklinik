        ...
        <div class="card-body table-responsive">
            <div class="row">
                <div class="col-md-4 offset-md-4">
                    <form action="{{url ('/perawat/store')}}" method="post">
                        @csrf
                        <div class="form-group">
                            <label> Nama Perawat</label>
                            <input type="text" name="nama_perawat" class="form-control" autofocus required>
                        </div>
                        ...
                        <div class="form-group">
                            <label> Level</label>
                            <input type="level" name="level" class="form-control" autofocus required>
                        </div>
